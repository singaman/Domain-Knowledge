...
### 1. WBC-20150: Role-Restricted Document Download (Pre-Signed URLs)
- **Story Points:** 8
- **Status:** Done
...
### 2. WBC-20151: ClamAV Malware Scanning Middleware
- **Story Points:** 3
- **Status:** Done
- **Technical Implementation:**
...
### 3. WBC-20152: AWS S3 Document Upload API for Bank Guarantees
- **Story Points:** 5
- **Status:** Done
- **Technical Implementation:**
