...
### 1. WBC-20217: Multi-Role Search and Reporting Aggregation API
- **Story Points:** 8
- **Status:** Done
...
### 2. WBC-20218: PDF Generation from Approved Guarantees
- **Story Points:** 5
- **Status:** Done
- **Technical Implementation:**
...
### 3. WBC-20219: Metrics and APM (Datadog) Instrumentation
- **Story Points:** 3
- **Status:** Done
- **Technical Implementation:**
